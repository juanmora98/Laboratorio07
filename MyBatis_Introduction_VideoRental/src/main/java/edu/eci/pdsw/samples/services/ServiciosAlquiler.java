...
public interface ServiciosAlquiler {
   ...
   */
   ...
   /**
   * @obj consultar el valor de la multa del alquiler, dado el id del 
item
   ...
   * @return la multa en funcion del numero de dias de retraso. Si el 
item se
   ...
   * cliente
   * @throws ExcepcionXX si el identificador no corresponde con un item, 
o si
   ...
   * @return el costo total del alquiler, teniendo en cuesta el costo 
diario y
   * el numeo de dias del alquiler
   * @throws ExcepcionServiciosAlquiler si el identificador del item no 
existe
   */
